...
// Assignment: The main screen of an assignment, there you can choose different exercises, once an exercise is selected
...
{
    //Text is where the exercise text of the current exercise is stored
    text = "";
    corrCount = 0;
    incorrPos = -1;
    textPos = 0;
